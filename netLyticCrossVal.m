% Tento skript slouží k naučení modelu pro klasifikaci osteolytické tkáně
% s využitím augmentace datasetu a následné křížové validace a následnému 
% vyhodnocení úspěšnosti klasifikace (a to i na obratel)
...
trainOpt = trainingOptions('adam','Plots','none',...
                   ...
                   'GradientDecayFactor',0.82,'SquaredGradientDecayFactor',0.97,...
