% Tento skript slouží k naučení modelu pro klasifikaci zdravé, osteolytické
% i osteoblastické tkáně s využitím augmentace datasetu a následné křížové
% validace a následnému vyhodnocení úspěšnosti klasifikace (a to i na obratel)
